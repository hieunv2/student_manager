...
public class StudentData {
    ...
    public void addStudent(String name, String email, String phone,String mssv,int age,String sex,String address) {
            try {
                ...
                PreparedStatement preStatement = connection.prepareStatement("INSERT INTO Students ( name, age, email, phone, mssv,sex, address ) VALUES  (" + "?,?,?,?,?,?,?)");
                preStatement.setString(1, name);
                ...
                Student student = new Student(name, age, email,phone,mssv,sex,address);
                listStudents.add(student);
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//
    public void deleteStudent(Student student) {
        ...
        try {
            ...
            PreparedStatement preStatement = connection.prepareStatement("DELETE FROM Students WHERE id = ?");
